...
export const command = 'send_challenge <challengeName> <githubUser> <resumeUrl> <reviewer1> <reviewer2>';
export const desc = 'Sends a challenge to a specific <ghUser> and add the <reviewersList> to it';
